...
public class ReflectionVsLambdaVsHandles {
    ...
    private Method getReflectiveMethod() throws ReflectiveOperationException {
        return ReflectionVsLambdaVsHandles.class.getMethod("toHashCodeString", Object.class);
    }
    ...
    public Object exceptionReflection() {
        try {
            return (String) aMethod.invoke(null, nil);
